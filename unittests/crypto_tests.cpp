...
BOOST_AUTO_TEST_CASE(crypto_tests_ecc) {
  ...
  ECC.normalizeSignature(sig1In, sig1);

  blockmirror::Signature sig2;
  std::vector<uint8_t> sig2In = {
  ...
  ECC.normalizeSignature(sig2In, sig2);

  blockmirror::Signature dsig1;
  std::vector<uint8_t> dsig1In = {
  ...
  ECC.normalizeSignature(dsig1In, dsig1);
  blockmirror::Signature dsig2;
  std::vector<uint8_t> dsig2In = {
  ...
  ECC.normalizeSignature(dsig2In, dsig2);
